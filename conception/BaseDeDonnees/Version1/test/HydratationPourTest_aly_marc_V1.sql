...
id_marque) 
values
("rouge","5008",45.3,"EW-900-JI",now(),"Superbe voiture rouge",34000,"climatisation et GPS", @id_agence, @id_categorie, @id_carburant, @id_marque);
...
-- call addVehicule("abis","berline","super98","renault","Megane","./mon/chemin/monimage.jpg", "rouge", 45.6,
-- "TW-000-XX", now(),"super voirure",65000,"GPS");

-- call addVehicule("abis","citadine","diesel","renault","C4", "./mon/chemin/monimage2.jpg", "verte", 60,
...
-- call updateVehicule(6,6,"abis","citadine","diesel","renault","Picasso", "./mon/chemin/update.jpg", "verte", 60,
