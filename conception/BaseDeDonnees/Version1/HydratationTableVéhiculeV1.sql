...
call addVehicule("ABIS","petite_citadine","électrique","fiat","500","/assets/images/petite_citadine/Fiat500_electrique.png", "bleue", 35,
"TW-222-YZ", now(),"Véhicule très maniable. Idéal pour vos trajets en ville. ",5000,"GPS / Android Auto / AppleCar");

call addVehicule("ABIS","petite_citadine","électrique","citroën","Ami", "/assets/images/petite_citadine/citroen-ami.png", "grise", 25,
"TW-333-YZ", now(),"Véhicule très maniable. Idéal pour vos déplacement en centre ville ",5000,"Vitres");

call addVehicule("ABIS","petite_citadine","électrique","mercedes","Smart","/assets/images/petite_citadine/smart_mercedes.png", "noire", 45,
"TW-444-YZ", now(),"Véhicule très maniable. Idéal pour vos déplacement en centre ville ",6000,"Vitres");

call addVehicule("ABIS","petite_citadine","super98","renault","Twingo", "/assets/images/petite_citadine/Twingo_electrique.png", "bleue", 40.5,
